...
{
    public interface IRemoveImageObjectCommand
    {
        Task<Result> RemoveImageObject(RemoveImageRequest request);
    }

    public class RemoveImageObjectCommand : CommandBase, IRemoveImageObjectCommand
    {
        private readonly ILogger _logger;
        public RemoveImageObjectCommand(IAmazonDynamoDB dynamoDbClient, IOptions<DynamoDbOptions> dynamoDbOptions,
